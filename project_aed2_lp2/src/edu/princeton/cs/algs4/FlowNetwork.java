...
public class FlowNetwork {
    ...
    public FlowEdge getEdge(FlowEdge e) {
        for (FlowEdge key : this.edges()) {
            if (e.equals(key)) {
                return key;
            }
        }
    ...
    public boolean removeFlowEdge(FlowEdge e)
    {
         for (FlowEdge key : this.edges()) {
            if (e.equals(key)) {
     ...
     * FlowNetwork G = new FlowNetwork(in); StdOut.println(G);
    }
     */
}
